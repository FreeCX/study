...
Далее переходим на главную страницу Cloudera Manager во вкладку Hosts->Configuration, где 
...
\begin{figure}[ht!]
    \center
    \includegraphics[width=0.\textwidth]{image-009}
...
\begin{thebibliography}{10}
    \bibitem{parcels} \url{http://www.cloudera.com/content/cloudera/en/documentation/cloudera-manager/v4-7-3/Cloudera-Manager-Release-Notes/cmrn_fixed_in_4_7_2.html}
    \bibitem{python} \url{http://www.shayanderson.com/linux/install-python-3-on-centos-6-server.htm}
    \bibitem{pip} \url{http://superuser.com/questions/773949/how-to-install-python-3-2-2-on-centos-6-5-amd64-preserving-its-original-python-i}
    \bibitem{moses:baseline} \url{http://www.statmt.org/moses/?n=Moses.Baseline}
    \bibitem{moses:dev} \url{http://www.statmt.org/moses/?n=Development.GetStarted}
\end{thebibliography}